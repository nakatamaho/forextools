...
cd OpenBLAS-0.2.8
make CC=gcc FC=gfortran SMP_SERVER=yes NUM_THREADS=8 DYNAMIC_ARCH=1
make PREFIX=/usr/local install CC=gcc FC=gfortran SMP_SERVER=yes NUM_THREADS=8 DYNAMIC_ARCH=1
